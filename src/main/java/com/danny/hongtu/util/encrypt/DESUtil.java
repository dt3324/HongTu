package com.danny.hongtu.util.encrypt;

import com.danny.hongtu.util.Base64;
...
public class DESUtil {
 ...
 public static void main(String[] args) throws UnsupportedEncodingException {
     ...
     System.out.println(sourse+"DES加密后为:"+encryString);
     System.out.println(encryString+"DES解密后为:"+decryString);
}
}
